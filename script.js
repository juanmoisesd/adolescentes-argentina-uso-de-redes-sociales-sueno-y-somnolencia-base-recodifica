...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log('Dataset page loaded: This dataset is a recoded version of the publicly available data from P&eacute;rez-Chada et al. ("Screen use, sleep duration, daytime somnolence, and academic performance in school-aged adolescents", Mendeley Data / PLOS ONE). It includes 1,257 adole');
